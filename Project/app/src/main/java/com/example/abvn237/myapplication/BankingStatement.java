...
public class BankingStatement extends AppCompatActivity
    ...
    public CheckBox chkSaving,chkCheque,chkVISA,chkDebit;
    SQLiteDatabase db;
    ...
    private ListView lsSavings, lsCheque, lsCash , lsDebit, lsVISA;
    private ListView lsAdapterSavings,lsAdapterCheque,lsAdapterCash, lsAdapterdebit, lsAdapterVISA;
    private ListAdapter adapterSavings, adapterCheque,adapterCash,adapterDebit,adapterVISA;
    // Adapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lsShowStatement = new ListView(this);
        String[] statement={"R200","R3000","R4000","R5000","R6000","R7000"};
        ArrayAdapter <String> adapter = new ArrayAdapter<String>(this,R.layout.activity_banking_statement,R.id.lsShowStatement,statement);
        lsShowStatement.setAdapter(adapter);
        SQLiteDatabase db;
        ...
        chkSaving = (CheckBox) findViewById(R.id.chkSavings);
        chkDebit = (CheckBox) findViewById(R.id.chkDebit);
        chkVISA = (CheckBox) findViewById(R.id.chkVISA);
        chkCheque = (CheckBox) findViewById(R.id.chkCheque);

        chkSaving.setOnClickListener(checkboxClickListener);
        chkDebit.setOnClickListener(checkboxClickListener);
        chkVISA.setOnClickListener(checkboxClickListener);
        chkCheque.setOnClickListener(checkboxClickListener);
