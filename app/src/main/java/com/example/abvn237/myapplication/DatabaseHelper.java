...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void addTransaction(Trend trend,AccType accType,SQLiteDatabase db){
       ...
       // db.openOrCreateDatabase("BusinessBankingApp29.sql",MODE_PRIVATE,null);
        ...
        values.put(Database.Trend.TREND_DATE, trend.getTrendDate());
        values.put(Database.Trend.TREND_TIME, trend.getTrendTime());
        values.put(Database.Trend.BALANCE,  trend.getBalance());
        values.put(Database.Trend.ACC_TYPE_ID,  accType.getAccTypeId());
        values.put(Database.Trend.ACC_NR,  trend.getAccountNumber());
       ...
       /* String sql = " INSERT INTO Trend (TREND_DATE,TREND_TIME,BALANCE,ACC_TYPE_ID,ACC_NR) VALUES(?,?,?,?,?);";
        ...
        stmt.bindString(1, trend.getTrendDate());
        stmt.bindString(2, trend.getTrendTime());
        stmt.bindString(3, trend.getBalance());
        stmt.bindString(4, trend.getAccTypeId());
        stmt.bindString(5, trend.getAccountNumber());
